...
# Retriever that contains notes on how to use EasyJailbreak
easyjailbreak_notes = get_retriever(
    './data/easyjailbreak',
    'easyjailbreak_how',
    'Steps to take to run pentests on a LLM using the \
    "EasyJailbreak" framework. ALWAYS run this before using the \
    start_easyjailbreak_attack tool, because it will explain how to use the \
    tool'
)
