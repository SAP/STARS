...
from libs.easyjailbreak import Cipher, CodeChameleon, DeepInception, ICA, \
    Jailbroken, Multilingual, ReNeLLM, \
    OUTPUT_FILE as easyjailbreak_out_file
...
class AttackSpecification:
    ...
    def output_file(self):
        ...
        match self.attack:
            ...
            case 'cipher' | 'codechameleon' | 'deepinception' | 'ica' | 'jailbroken' | 'multilingual' | 'renellm':  # noqa: E501
                return easyjailbreak_out_file
